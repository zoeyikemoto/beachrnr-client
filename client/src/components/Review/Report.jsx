...
class ModalModalExample extends React.Component {
  ...
  render() {
    return(
      <div>
        <Icon onClick={this.show.bind(this)} className='flagicon' name='flag outline'/>
        <Modal open={this.state.open}>
          ...
          <Modal.Content>
            <Modal.Description>
                ...
                <Button color='black' onClick={this.close.bind(this)} disabled={this.state.report_reason === ''}>
                  Submit
                </Button>
            </Modal.Description>
          </Modal.Content>
